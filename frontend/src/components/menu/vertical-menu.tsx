    ...
    <ul className="nav nav-pills flex-column">
      ...
      <li>
        <NavLink className="nav-link" to="/contact" end>
          {collapsed ? <span title="Contact Me"><MailOutlineIcon /></span> : 'Contact Me'}
        </NavLink>
      </li>
      <li>
        <NavLink
      ...
      <li>
        <button
          type="button"
          className="nav-link with-caret nav-link-disabled"
          title="Career Hub is temporarily disabled"
          disabled
        >
          {collapsed ? <span title="Career Hub (Inactive)"><WorkIcon /></span> : 'Career Hub (Inactive)'}
        </button>
      </li>
    </ul>
    </div>
